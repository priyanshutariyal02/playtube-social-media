...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-bg-primary/90 backdrop-blur-md border-b border-border-subtle px-4 lg:px-8 py-3 transition-colors duration-200">
      <div className="flex items-center justify-between gap-4">
        ...
        <div ref={searchRef} className="hidden md:flex flex-1 max-w-md relative">
          ...
          {isSearchOpen && searchQuery.trim() && (
            <div className="absolute top-12 left-0 right-0 bg-bg-surface border border-border-subtle rounded-md shadow-2xl shadow-black/30 p-3 z-50 flex flex-col gap-2 max-h-96 overflow-y-auto animate-slide-up">
